...
#dispachDict: = {}
# if filename.startswith("dltext") #if not filename.startswith("."):
#with open (f"{directory}{filename}, "r") as file


file = "/Users/koppens/Dropbox/Geschichte/Digital_Humanities/RomanovClass/dispachissue1.xml"
def read_file(file):
    ...
    ReallyFinalData = "\n\n".join(allData)
    with open(file.replace("dis", "splitdis"), "w", encoding="utf8") as f10:
